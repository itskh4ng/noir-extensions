...
<title>Noir Extensions</title>
</head>
<body ` + isPageDev() + `>
<div class="nav">
<div class="nav-left">
<div class="nav-title">Noir Extensions</div>
<div class="nav-right">
...
<div class="wrongpage">You are not on the correct page.<br>To use Noir Extensions click the button below to redirect and run the bookmarklet again.<div class="item-left-buttons" style="justify-content: center; margin: 20px;">
